...
-  Insert your own copyright line(s) after the existing ones, if any
  ...
  [DCO]: https://github.com/chindraba-work/git-populate/blob/master/docs/DCO
  [LMD]: https://github.com/chindraba-work/git-populate/blob/master/LICENSE
  ...
  [issue]: https://github.com/chindraba-work/git-populate/issues
  [pull]: https://github.com/chindraba-work/git-populate/pulls
